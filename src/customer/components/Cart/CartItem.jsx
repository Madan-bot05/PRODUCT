...
console.log("pricessss",item.size)
  ...
  return (
    <div className="p-5 shadow-lg border rounded-md">
      <div className="flex items-center">
        ...
        <div>
          <h2 className="font-semibold ml-5">{item.product.title}</h2>
          ...
          <div className="ml-5 space-y-1">
            <div className="flex space-x-5 items-center text-gray-900 mt-6">
              ...
              <p className="text-green-600">{item.discountedPercent}</p>
            </div>
          </div>
          <div className="lg:flex items-center lg:space-x-10 py-10">
            ...
            <div>
              ...
              <button className="button" onClick={handleRemoveCartItem}>
                <svg
